...
namespace Application.Features.Brands.Queries.GetByIdBrand
{
    public class GetByIdBrandQuery : IRequest<BrandGetByIdDto>
    {
        ...
        public class GetByIdBrandQeuerHandler : IRequestHandler<GetByIdBrandQuery, BrandGetByIdDto>

        {
            ...
            public GetByIdBrandQeuerHandler(IBrandRepository brandRepository, IMapper mapper, BrandBusinessRules brandBusinessRules)
            {
            ...
            public async Task<BrandGetByIdDto> Handle(GetByIdBrandQuery request, CancellationToken cancellationToken)
            {
                ...
                await _brandBusinessRules.BrandSholdExistWhenRequested(brand);
